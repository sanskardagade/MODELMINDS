    ...
    <div className="min-h-screen bg-[#000000] text-[#F2F2F2] px-6 md:px-16 py-20">
      ...
      >
        <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
          ...
          <span className="text-[#f97316]">ModelMinds</span>
        </h1>
        <p className="text-[#B6B09F] text-lg leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {insights.map((item, index) => (
          ...
          >
            ...
            <div className="p-6">
              <p className="uppercase text-sm text-[#EAE4D5] font-semibold tracking-wider mb-2">
                {item.category}
              </p>
              <h2 className="text-2xl font-semibold mb-3 text-[#F2F2F2]">
                {item.title}
              </h2>
              <p className="text-[#B6B09F] text-sm leading-relaxed mb-4">
                {item.description}
              </p>
      ...
      >
        <h2 className="text-4xl font-bold mb-6 text-[#EAE4D5]">
          Join the World of{" "}
          <span className="text-[#f97316]">ModelMinds</span>
        </h2>
        <p className="text-[#B6B09F] mb-8 max-w-xl mx-auto">
        ...
        <form className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-lg mx-auto">
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-lg bg-[#848884] text-white hover:bg-[#f97316] active:bg-[#f97316] hover:text-white transition duration-300 shadow-md hover:shadow-[#f97316]/50"
          >
            Subscribe
          </button>
        </form>
